...
const characterJson = JSON.stringify(character.character);

console.log(characterJson);
  
// Mostrar la cantidad de caracteres del JSON
console.log(`El JSON tiene ${characterJson.length} caracteres.`);
